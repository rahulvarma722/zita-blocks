...
if (!function_exists('zita_blocks_render_post_slider')) {
            ...
            if ($query->have_posts()) {
                ...
                while ($query->have_posts()) {
                    ...
                    if (get_the_post_thumbnail_url()) {
                        ...
                        // three divs
                        $postHtml .= '<div class="zita-slider-image-container" style="background-image: url(' . esc_url(get_the_post_thumbnail_url()) . ');"></div>';
                        ...
                        if ($postDateModify) {
                            ...
                            $postHtml .= __('Modified', "zita-blocks") . ":<a target='_blank' href='" . esc_url(get_day_link($dateYear, $dateMonth, $dateDay)) . "'>";
