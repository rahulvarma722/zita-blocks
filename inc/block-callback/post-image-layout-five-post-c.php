...
if (!function_exists('zita_blocks_section_five_post')) {
    function zita_blocks_section_five_post($attr)
    {
        ...
        if (isset($attr['numberOfPosts']) && intval($attr['numberOfPosts'])) {
            ...
            if ($query->have_posts()) {
                ...
                $postHtml .= "<div class='zita-post-five-post column-count parent-column-two count-3 post-five-layout-" . $contentLayoutType . " content-align-" . $contentAlign . " content-placed-" . $contentPlaced . "'  data-setting='" . $postSetting . "' data-currentpage='" . $currentPage . "'>";
                $checkFirst = true;
                ...
                while ($query->have_posts()) {
                    ...
                    if ($contentLayoutType == 2) {
                        if ($CountTwoLayout > 4) {
                            ...
                            $CountTwoLayout++;
                            $columnTwo .= zita_blocks_returnHtmlListPost($showCate2_, $heading2_, $postAuthor2, $metaStyle2_, $date2_, $Excerpt2_, $ShowTa2g, $args, [["enable" => true]], $layout_);
                        }
