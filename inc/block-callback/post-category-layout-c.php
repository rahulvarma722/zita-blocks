...
function zita_blocks_two_column_block($attr)
{
    ...
    if ($query->have_posts()) {
        ...
        while ($query->have_posts()) {
            ...
            if ($checkFirst) {
                $checkFirst = false;
                // zita_blocks_returnHtmlListPost($cate_, $heading__, $postAuthor, $meta_, $postDate, $postExcerpt, $postExcerpt__, $postDateModify, $postExcerptColor, $tags_, $category__in, $thumbnail = false)
                $postHtmlCl1  .= zita_blocks_returnHtmlListPost($attr['showCate'], $attr['heading'], $postAuthor, $attr['meta_style'], $postDate, $postExcerpt, $attr['excerpt'], $postDateModify, $postExcerptColor, $attr['showTag'], $args, $attr['thumbnail']);
                ...
                $postHtmlCl2  .= zita_blocks_returnHtmlListPost($attr['showCate'], $attr['heading'], $postAuthor, $attr['meta_style'], $postDate, $postExcerpt, $attr['excerpt'], $postDateModify2, $postExcerpt2Color, false, $args, $attr['thumbnail2']);
