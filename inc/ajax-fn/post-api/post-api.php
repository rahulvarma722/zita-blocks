...
// zita-blocks post block api 
if (!function_exists('zita_blocks_post_apis')) {
...
if (!function_exists('zita_blocks_post_apis_result')) {
...
if (!function_exists('Zita_blocks_Post_Filter')) {
...
if (!function_exists('Zita_blocks_Post_Api_firstTimeIntilize')) {
