<?php
function zita_post_layout_grid()
{
    $attr = $_POST['attr'];
    ...
    echo zita_post_layout_grid_html($args, $attr) ? zita_post_layout_grid_html($args, $attr) : 0;
    die();
}
add_action('wp_ajax_zita_post_layout_grid', "zita_post_layout_grid");
add_action('wp_ajax_nopriv_zita_post_layout_grid', "zita_post_layout_grid");
// return html function
function zita_post_layout_grid_html($args, $attr)
{
